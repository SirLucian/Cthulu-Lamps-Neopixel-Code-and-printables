...
void loop()
{
  brightPotVal = analogRead(brightIn);
  huePotVal = analogRead(hueIn);
  buttonState = digitalRead(buttonPin);
//  Detect button push to change the mood
if (buttonState == HIGH) {   
    nextPattern();
    delay(200);
  }  
  ...
  // Print to serial for debugging purposes - You may comment this out 
  Serial.println((String)"A0: "+brightnessVal+", A1: "+huePotVal+", Button: "+buttonState);

  // Set the brightness using the brightness potentiometer
